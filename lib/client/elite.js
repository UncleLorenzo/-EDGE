...
(function () {
  ...
  function normalizeFooter() {
    ...
    if (!footer || footer.querySelector('a[href="/tracker.html"]')) return;
    var rows = footer.querySelectorAll("div"), linkRow = null;
    for (var i = rows.length - 1; i >= 0; i--) { if (rows[i].querySelector("a")) { linkRow = rows[i]; break; } }
    if (!linkRow) return;
