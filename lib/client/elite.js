...
(function () {
  ...
  function css() {
    return [
      ...
      "#wlModal #wlWallet{margin:0 0 14px}#wlModal #wlEmail{margin:0 0 16px}",
    ...
    m.innerHTML =
      ...
      '<div class="wl-card" role="dialog" aria-modal="true" aria-labelledby="wlTitle">' +
        ...
        '<form id="wlForm" novalidate>' +
          '<label class="wl-label" for="wlWallet">Solana / ETH wallet · for the airdrop</label>' +
          '<input id="wlWallet" class="wl-input" type="text" placeholder="paste your Solana or 0x… ETH wallet" spellcheck="false" autocapitalize="off" autocorrect="off" required>' +
